...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="worker-user-table.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding  w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Table Information</a> 
    ...
    <a href="#contact" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-close fa-fw w3-margin-right"></i>Log out</a>
  </div>
</nav>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-padding-32 w3-bottombar" id="table-info">  
    <h2><b>Table Information</b></h2><br>
    <?php
...
$sql = "SELECT rid, max_size, description, remaining_no, total_no FROM room";
...
if ( $pages > 1 )  // show previous page
   echo "<a href='worker-user-table.php?Pages=".($pages-1).
        "'>Last</a>| ";
for ( $i = 1; $i <= $total_pages; $i++ )
   if ($i != $pages)
     echo "<a href=\"worker-user-table.php?Pages=".$i."\">".
          $i."</a> ";
   else
     echo $i." ";
...
<div class="w3-container w3-padding-32 w3-bottombar" id="table-add">  
    <h2><b>Add Table Information</b></h2><br>
    <?php
...
if (isset($_POST["Insert"])) {
   ...
   $sql ="INSERT INTO room (rid, max_size, description, remaining_no,";
   $sql.=" total_no) VALUES ('";
   $sql.=$_POST["rid"]."','".$_POST["max_size"]."','";
   $sql.=$_POST["description"]."','".$_POST["remaining_no"]."','";
   $sql.=$_POST["total_no"]."')";
...
?>
<form action="worker-user-table.php" method="post">
<table border="1">
<tr><td>id:</td>
   <td><input type="text" name="rid" size ="6"/></td>
</tr><tr><td>size:</td>
   <td><input type="text" name="max_size" size="12"/></td>
</tr><tr><td>description:</td>
   <td><input type="text" name="description" size="25"/></td>
   </tr><tr><td>remaining no:</td>
   <td><input type="text" name="remaining_no" size="6"/></td>
</tr><tr><td>total no:</td>
   <td><input type="text" name="total_no" size="25"/>
	 </td></tr>
</table><hr/>
...
<div class="w3-container w3-padding-32 w3-bottombar" id="table-update">  
    <h2><b>Update Table Information</b></h2><br>
    <?php
...
if (isset($_POST["Update"])) {   
   ...
   $sql = "UPDATE room SET ";
   $sql.= "max_size='".$_POST["max_size-1"]."',";
   $sql.= "description='".$_POST["description-1"]."',";
   $sql.= "remaining_no='".$_POST["remaining_no-1"]."',";
   $sql.= "total_no='".$_POST["total_no-1"]."'";
   $sql.= " WHERE rid = '".$_POST["rid-1"]."'";
...
?>
<form action="worker-user-table.php" method="post">
id: <input type="text" name="rid-1" size ="6"/>
<br><br>
<table border="1">
<tr><td>size:</td>
   <td><input type="text" name="max_size-1" size="25"/>
	 </td></tr>
     <tr><td>description:</td>
   <td><input type="text" name="description-1" size="25"/>
	 </td></tr>
     <tr><td>remain no:</td>
   <td><input type="text" name="remaining_no-1" size="25"/>
	 </td></tr>
     <tr><td>total no:</td>
   <td><input type="text" name="total_no-1" size="25"/>
	 </td></tr>
</table><hr/>
...
<div class="w3-container w3-padding-32 w3-bottombar" id="table-delete">  
    <h2><b>Delete Table Information</b></h2><br>
    <?php
...
<table border="1">
<tr><td>id:</td>
   <td><input type="text" name="rid-2" size ="6"/></td>
</tr>
</table><hr>
  ...
  <div class="w3-row-padding w3-padding-32">
    ...
    <div class="w3-third w3-serif">
      ...
      <p>
        ...
        <a href="#worker-table-home" class="w3-button"><i class="fa fa-arrow-up w3-margin-right"></i>To the top</a>
