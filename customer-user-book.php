...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="welcome.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-home fa-fw w3-margin-right"></i>Home</a> 
    <a href="customer-user-food.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Favorite Food</a> 
    <a href="customer-user-chef.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Favorite Chef</a> 
    <a href="customer-user-book.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Booking message</a> 
    <a href="customer-user-information.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw w3-margin-right"></i>Personal Information</a>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>Welcome to KAWIHOVIES, <?php echo $_SESSION['username']; ?></b></h1>
    ...
    <div class="w3-third w3-serif">
      ...
      <p>
        ...
        <div class="w3-xlarge w3-section">
            <a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fum.edu.mo" class="fa fa-facebook-official w3-hover-opacity"></a>
            <a href="https://plus.google.com/share?url=http%3A%2F%2um.edu.mo" class="fa fa-google w3-hover-opacity"></a>
