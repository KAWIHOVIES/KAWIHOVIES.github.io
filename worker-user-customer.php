...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="worker-user-customer.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Customer Information</a> 
...
<div class="w3-container w3-padding-32 w3-bottombar" id="chef-info">  
    <h2><b>Customer Information</b></h2><br>
    <?php
...
$sql = "SELECT id, username, phone, email, birthday, password, timeStamp FROM users";
...
if ( $pages > 1 )  // show previous page
   echo "<a href='worker-user-customer.php?Pages=".($pages-1).
        "'>Last</a>| ";
for ( $i = 1; $i <= $total_pages; $i++ )
   if ($i != $pages)
     echo "<a href=\"worker-user-customer.php.php?Pages=".$i."\">".
          $i."</a> ";
   else
     echo $i." ";
...
<div class="w3-container w3-padding-32 w3-bottombar" id="chef-add">  
    <h2><b>Add Customer Information</b></h2><br>
    <?php
...
if (isset($_POST["Insert"])) {
   ...
   $sql ="INSERT INTO users (id, username, phone, email, birthday, password,";
   $sql.=" timeStamp) VALUES ('";
   $sql.=$_POST["id"]."','".$_POST["username"]."','";
   $sql.=$_POST["phone"]."','".$_POST["email"]."','";
   $sql.=$_POST["birthday"]."','";
   $sql.=$_POST["password"]."','".$_POST["timeStamp"]."')";
...
?>
<form action="worker-user-customer.php" method="post">
<table border="1">
<tr><td>id:</td>
   ...
   <td><input type="text" name="email" size="6"/></td>
   </tr><tr><td>birthday:</td>
   <td><input type="text" name="birthday" size="6"/></td>
   </tr><tr><td>password:</td>
   <td><input type="text" name="password" size="12"/></td>
</tr><tr><td>timeStamp:</td>
   <td><input type="text" name="timeStamp" size="25"/>
	 </td></tr>
</table><hr/>
...
<div class="w3-container w3-padding-32 w3-bottombar" id="chef-info">  
    <h2><b>Update customer Information</b></h2><br>
    <?php
...
if (isset($_POST["Update"])) {   
   ...
   $sql.= "timeStamp='".$_POST["timeStamp-1"]."',";
   $sql.= "username='".$_POST["username-1"]."',";
   $sql.= "phone='".$_POST["phone-1"]."',";
   $sql.= "email='".$_POST["email-1"]."',";
   $sql.= "birthday='".$_POST["birthday-1"]."',";
   $sql.= "password='".$_POST["password-1"]."'";
   $sql.= " WHERE id= '".$_POST["id-1"]."'";
...
?>
<form action="worker-user-customer.php" method="post">
id: <input type="text" name="id-1" size ="6"/>
<br><br>
<table border="1">
<tr><td>name:</td>
   <td><input type="text" name="username-1" size="25"/>
	 </td></tr>
     <tr><td>phone:</td>
   <td><input type="text" name="phone-1" size="25"/>
	 </td></tr>
     <tr><td>email:</td>
   <td><input type="text" name="email-1" size="25"/>
	 </td></tr>
     <tr><td>birthday:</td>
   <td><input type="text" name="birthday-1" size="25"/>
	 </td></tr>
     <tr><td>password:</td>
   <td><input type="text" name="password-1" size="25"/>
	 </td></tr>
   <tr><td>timeStamp:</td>
   <td><input type="text" name="timeStamp-1" size="25"/>
	 </td></tr>
</table><hr/>
...
<div class="w3-container w3-padding-32 w3-bottombar" id="chef-info">  
    <h2><b>Delete Customer Information</b></h2><br>
    <?php
...
<table border="1">
<tr><td>id:</td>
   <td><input type="text" name="id-2" size ="6"/></td>
</tr>
</table><hr>
