...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="welcome.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-home fa-fw w3-margin-right"></i>Home</a> 
    ...
    <a href="customer-user-book.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Booking message</a> 
  ...
  <div class="w3-row-padding w3-padding-32">
    ...
    <div class="w3-third w3-serif">
      ...
      <p>
        ...
        <a href="#customer-home" class="w3-button"><i class="fa fa-arrow-up w3-margin-right"></i>To the top</a>
